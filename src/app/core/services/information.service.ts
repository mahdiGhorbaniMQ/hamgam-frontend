...
export class InformationService {
  ...
  constructor(
    ...
    users.allUsers = [
      {
        ...
        bio:"من در حوزه وب فعالیت دارم\nراه های ارتباطی: t.me://mahdighorbanimqمن در حوزه وب فعالیت دارم\nراه های ارتباطی: t.me://mahdighorbanimqمن در حوزه وب فعالیت دارم\nراه های ارتباطی: t.me://mahdighorbanimqمن در حوزه وب فعالیت دارم\nراه های ارتباطی: t.me://mahdighorbanimq",
        skills:[]
      },
      {
        id:"1",
    ...
    ideas.allIdeas = [
      {
        id:"0",
        title:"سلام این اولین ایده من هستسلام این اولین ایده من هستسلام این اولین ایده من هستش.",
...
این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است
این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است
این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است
این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است
این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است
این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است این یک متن طولانی است
